...
window.blockly.js.blockly.APIGoogleMaps.Adicionar_marcador = function() {
 var item, destino, saida;
  this.cronapi.maps.createMarker("map5590", 'cronappId', 'Sede CronApp', this.cronapi.maps.createLatLngPoint('-12.9992582', '-38.4690056'), 'cronapp-nuvem.png', '<h2 style=\"text-align: center;\">Sede do Cronapp em Salvador</h2>\n<h3 style=\"text-align: center;\"><a href=\"https://www.cronapp.io\" target=\"blank\"> https://www.cronapp.io </a></h3>', '');
}
